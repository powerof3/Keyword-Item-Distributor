...
namespace Cache
{
	...
	namespace Archetype
	{
		inline constexpr frozen::unordered_map<std::string_view, RE::EffectArchetype, 48> map = {
	...
	{
		inline constexpr frozen::unordered_map<std::string_view, RE::ActorValue, 164> map = {
