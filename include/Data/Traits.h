...
private:
	...
	std::optional<Range<float>>                     armorRating{};
	std::optional<RE::BIPED_MODEL::ArmorType>       armorType{};
	std::optional<Range<float>>                     weight{};
	std::optional<RE::BIPED_MODEL::BipedObjectSlot> slot{};
};
...
private:
	...
	std::optional<bool>            enchanted{};
	std::optional<bool>            templated{};
	std::optional<RE::WEAPON_TYPE> animationType{};
	std::optional<Range<float>>    damage{};
	std::optional<Range<float>>    weight{};
};
...
public:
	...
	bool PassFilter(RE::TESForm* a_item) const override
	{
		...
		if (skill) {
			const auto& [skillType, minMax] = *skill;
...
private:
	// members
	std::optional<RE::MagicSystem::CastingType>                   castingType{};
	std::optional<RE::MagicSystem::Delivery>                      deliveryType{};
	std::optional<std::pair<RE::ActorValue, Range<std::int32_t>>> skill{};
	std::optional<RE::ActorValue>                                 resistance{};
...
private:
	...
	std::optional<RE::ActorValue> actorValue{};
};
...
private:
	...
	std::optional<RE::SOUL_LEVEL> soulSize{};
	std::optional<RE::SOUL_LEVEL> gemSize{};
};
...
private:
	// members
	std::optional<RE::MagicSystem::SpellType>   spellType{};
	std::optional<RE::MagicSystem::CastingType> castingType{};
	std::optional<RE::MagicSystem::Delivery>    deliveryType{};
	std::optional<RE::ActorValue>               skill{};
	std::optional<bool>                         isHostile{};
};
...
private:
	...
	// members
	std::optional<std::int32_t>                               furnitureType{};
	std::optional<RE::TESFurniture::WorkBenchData::BenchType> benchType{};
	std::optional<RE::ActorValue>                             useSkill{};
};
